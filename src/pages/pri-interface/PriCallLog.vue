        ...
        <el-col :span="22">
          <div class='pri-filter' :class="{'filter-hide': isFilterHide}">
            ...
            <div 
              ...
              :key="key"
             >
              <el-input v-model="filterItemsForm[key]" :placeholder="'请输入' + item" class="filter-item--input"></el-input>
            </div>
            ...
            <div class="filter-item">
              <el-select v-model="filterItemsForm.chainRemoveCommunity" placeholder="请选择拆链小区" class="filter-item--input">
                <el-option label="区域一" value="shanghai"></el-option>
                <el-option label="区域二" value="beijing"></el-option>
              </el-select>
            </div>
            ...
            <div class="filter-item">
              ...
              <el-input placeholder="请输入起始起呼公里标" class="filter-item--input"></el-input>
              <span class="continue-icon" > - </span>
              <el-input placeholder="请输入结束起呼公里标" class="filter-item--input"></el-input>
            </div>
            <div class="filter-item">
...
export default {
  ...
  data(){
    return {
      ...
      tableHead: {name:'姓名', address:'地址', age: '20', job: 'jjj', hobby: 'kkkk'},
      tableData: [],
      currentPage: 1,
      isFilterHide: true,
      tableHeight: '720'
