      ...
      <el-col :span="20">
        <div >
          <el-row class="joural-box">
            <el-col :span="6">
              <div @click="AlertDialog = true">
                <i class="el-icon-warning-outline" title="Emergency,Alert">{{Alert}}</i>
              </div>
            </el-col>
              <el-dialog
                title="日志信息"
            ...
            <el-col :span="6">
              <div @click="getSystemLog('Error')">
                <i class="el-icon-warning-outline" title="Critical,Error">{{Error}}</i>
              </div>
              <el-dialog
                title="日志信息"
            ...
            <el-col :span="6">
              <div @click="NotificationDialog = true">
                <i class="el-icon-warning-outline" title="Warning,Notification">{{Notification}}</i>
              </div>
              <el-dialog
                title="日志信息"
            ...
            <el-col :span="6">
              <div @click="DebuggingDialog = true">
                <i class="el-icon-warning-outline" title="Informational,Debugging">{{Debuging}}</i>
              </div>
              <el-dialog
                title="日志信息"
...
i[title="Emergency,Alert"]::before{
  background:red
}
i[title="Critical,Error"]::before{
  background:orange
}
i[title="Warning,Notification"]::before{
  background:yellow
}
i[title="Informational,Debugging"]::before{
  background:grey
}
.joural{
  background: #EBEEF5;
